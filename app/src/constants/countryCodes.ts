export interface CountryDialCode {
  name: string;
  iso2: string;
  dialCode: string; // digits only, no leading '+' — e.g. "91" for India
}

// Sorted alphabetically by name; dial codes are shared by multiple entries
// where that's genuinely how the world works (e.g. NANP: US/Canada/several
// Caribbean nations all dial out as +1).
...
export const DEFAULT_COUNTRY: CountryDialCode = COUNTRY_DIAL_CODES.find((c) => c.iso2 === "IN")!;

/** Regional-indicator-symbol trick: each letter maps to U+1F1E6..U+1F1FF. */
